...
export const imperativeStateManager = Effect.gen(function* () {
  const examples = yield* packageExamples("imperative-state-manager")
  ...
  const imperativeStateAdviceFromInput = (
  ...
  return imperativeStateAdviceFromInput
})
