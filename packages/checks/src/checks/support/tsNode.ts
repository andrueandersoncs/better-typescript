import { Array, Function, HashSet, Match, Option, pipe, Struct, flow } from "effect"
...
const singleReturnHasOne = flow(
  Struct.get<ReadonlyArray<ts.ReturnStatement>, "length">("length"),
  strictEqual(1)
)
