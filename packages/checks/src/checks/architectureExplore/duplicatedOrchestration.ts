import { Array, Effect, Function, Option, Record, Result, Struct, pipe } from "effect"
...
const makeDuplicatedOrchestration = (examples: NonEmptyRefactorExamples) => {
  ...
  return deriveSignals(duplicatedOrchestrationAdvice)
}

export const duplicatedOrchestration = pipe(
  packageExamples("duplicated-orchestration"),
  Effect.map(makeDuplicatedOrchestration)
)
