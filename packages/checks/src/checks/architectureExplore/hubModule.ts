...
const makeHubModule = (examples: NonEmptyRefactorExamples) => {
  ...
  return deriveSignals(hubAdvice)
}

export const hubModule = pipe(packageExamples("hub-module"), Effect.map(makeHubModule))
