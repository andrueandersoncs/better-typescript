...
const makeLeakedSeam = (examples: NonEmptyRefactorExamples) => {
  ...
  return deriveSignals(leakedSeamAdvice)
}

export const leakedSeam = pipe(packageExamples("leaked-seam"), Effect.map(makeLeakedSeam))
