...
export const systemicHotspots = Effect.gen(function* () {
  const examples = yield* packageExamples("systemic-hotspots")
  ...
  const systemicHotspotsAdviceFromInput = (input: SystemicHotspotsInput): Stream.Stream<Advice> => {
  ...
  return systemicHotspotsAdviceFromInput
})
