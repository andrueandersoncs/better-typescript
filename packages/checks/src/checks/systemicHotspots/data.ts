...
/**
 * One materialized batch of subsystem-density advice used to derive systemic hotspots.
 *
 * @modelRole boundary
 * @remarks This schema exists because replay must preserve hot-subsystem and signal-
 * density evidence as one validated batch. Removing it would duplicate synchronization
 * and positional pairing across the replay and preset wiring.
 */
 ...
 * hotSubsystem, highSignalDensity. Removing it would duplicate boundary translation and
