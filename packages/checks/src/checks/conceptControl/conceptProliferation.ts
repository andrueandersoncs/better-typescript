...
export const conceptProliferation = Effect.gen(function* () {
  const closedAbstractionExamples = yield* packageExamples("concept-control")
  const proliferationExamples = yield* packageExamples("concept-proliferation")
  ...
  const closedAbstractionAdvice = (element: Detection, data: ConceptSignalData): Advice => {
    ...
    return new Advice({
      ...
      evidence,
      examples: closedAbstractionExamples
    })
  }
  ...
  const proliferationAdvice = (
    ...
    const advice = new Advice({
      ...
      evidence,
      examples: proliferationExamples
    })
  ...
  return deriveSignals(conceptAdviceFor)
})
