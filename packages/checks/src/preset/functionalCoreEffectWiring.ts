...
const boundaryExamples = fixtureRefactorExamples(
...
export const makeFunctionalCoreEffectChecks = (
  ...
  Array.make(
    namedCheck(
      functionalCoreBoundaryCheckName,
      makeFunctionalCoreEffect(policy),
      boundaryExamples
    ),
    silentCheck(
      functionalCoreShapeCheckName,
      makeFunctionalCoreShapeEvidence(policy)
    )
  )

export const makeFunctionalCoreEffectWiring = (
  policy: FunctionalCoreEffectPolicy
): Wiring =>
  makeWiring({
...
export const functionalCoreEffectWiring: Wiring =
  makeFunctionalCoreEffectWiring(defaultFunctionalCoreEffectPolicy)
