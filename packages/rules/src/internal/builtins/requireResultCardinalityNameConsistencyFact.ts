...
// RequireResultCardinalityPluralForOneFact exists because its fields form one stable data contract used by the linter.
...
// RequireResultCardinalitySingularForManyFact exists because its fields form one stable data contract used by the linter.
