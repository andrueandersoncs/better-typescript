...
// NoBlankLinesBetweenSingleLineDeclarationsFact exists because its fields form one stable data contract used by the linter.
...
// emptyNoBlankLinesBetweenSingleLineDeclarationsFact exists because its fields form one stable data contract used by the linter.
