...
// PreferEffectSchemaRecordObjectFact exists because its fields form one stable data contract used by the linter.
...
// PreferEffectSchemaRecordTupleFact exists because its fields form one stable data contract used by the linter.
