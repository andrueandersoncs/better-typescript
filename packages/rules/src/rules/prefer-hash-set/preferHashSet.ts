...
import { makeHashCollectionPreferScanner } from "../../internal/builtins/hashCollectionMatches.js"
...
export const preferHashSetScanner =
  makeHashCollectionPreferScanner<PreferHashSetFact>(hashSetNames)(constructorFact)(
