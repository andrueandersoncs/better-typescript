...
import { declarationListIsConst } from "../../internal/support/declarationListIsConst.js"
...
// PreferEffectFunctionConstantFact exists because its fields form one stable data contract used by the linter.
...
export const preferEffectFunctionConstantScanner =
  makeNodeScanner(constantThunkKinds)(isFunctionInitializer)(functionConstantMatches)
