...
import type { Match as NodeMatch } from "../../internal/scanner/match.js"
...
const matchesDefinition =
  ...
  (
    ...
    pipe(semanticsFor(scan), Option.flatMap(findingForSemantics), Option.toArray)

const matches = flow(callableSemantics, matchesDefinition)

export const requireResultCardinalityNameConsistencyScanner = functionDefinitionScanner(matches)
