...
import { Array, Function, Option, Predicate, Schema, Tuple, pipe } from "effect"
...
// PreferEtaReductionFact exists because its fields form one stable data contract used by the linter.
