...
const makeCompositionFingerprints = () => {
  ...
  const walkVariableStatementDeclarations = (variableStatement: ts.VariableStatement) =>
    Array.flatMap(
      ...
      walkVariableDeclarationInitializer
    )
  ...
  return exportReferenceFileMatcher(compositionFingerprintElements)
}

export const compositionFingerprints = makeCompositionFingerprints()
