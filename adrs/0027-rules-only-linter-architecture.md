...
direct Rule-owned Violation construction with core-owned materialization from local findings.
ADR-0032 makes independent Rule ownership exclude cross-Rule verdict arbitration. The rules-only
