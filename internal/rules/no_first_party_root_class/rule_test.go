...
func TestRule(t *testing.T) {
	const diagnostic = "Avoid unsupported first-party classes. Use a class only when it extends another class without private methods. Replace root classes with functions, grouping them in a plain object when the namespace is part of the API."
