...
func TestRule(t *testing.T) {
	ruletest.Assert(t, "testdata", Rule, []analysis.Violation{
		...
		{RuleName: "related-kind-files", Level: "error", Message: "UserRepository is split from related types in src/wrong.ts. Its public signature relates it through {User}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/types.ts", Line: 3, Column: 18},
		{RuleName: "related-kind-files", Level: "error", Message: "OtherRepository is split from related types in src/wrong.ts. Its public signature relates it through {User}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/types.ts", Line: 4, Column: 18},
		...
		{RuleName: "related-kind-files", Level: "error", Message: "UserView is split from related types in src/types.ts. Its public signature relates it through {User}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/wrong.ts", Line: 13, Column: 18},
...
func TestClassRelationships(t *testing.T) {
	ruletest.Assert(t, "testdata/classes", Rule, []analysis.Violation{
		...
		{RuleName: "related-kind-files", Level: "error", Message: "FirstBox is split from related types in src/second/types.ts. Its public signature relates it through {ConstructorData}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/first/types.ts", Line: 2, Column: 14},
		...
		{RuleName: "related-kind-files", Level: "error", Message: "SecondBox is split from related types in src/first/types.ts. Its public signature relates it through {ConstructorData}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/second/types.ts", Line: 2, Column: 14},
	})
}
...
func TestStaticRelationships(t *testing.T) {
	ruletest.Assert(t, "testdata/statics", Rule, []analysis.Violation{
		{RuleName: "related-kind-files", Level: "error", Message: "FirstStatic is split from related types in src/b/types.ts. Its public signature relates it through {StaticData}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/a/types.ts", Line: 2, Column: 14},
		{RuleName: "related-kind-files", Level: "error", Message: "SecondStatic is split from related types in src/a/types.ts. Its public signature relates it through {StaticData}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/b/types.ts", Line: 2, Column: 14},
	})
}
...
func TestRecursiveEffectChannelPolicy(t *testing.T) {
	ruletest.Assert(t, "testdata/channel-policy", Rule, []analysis.Violation{
		...
		{RuleName: "related-kind-files", Level: "error", Message: "FirstRunner is split from related types in src/d/types.ts. Its public signature relates it through {SharedRepo}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/c/types.ts", Line: 3, Column: 18},
		{RuleName: "related-kind-files", Level: "error", Message: "SecondRunner is split from related types in src/c/types.ts. Its public signature relates it through {SharedRepo}. Place related types together in one dedicated module's types.ts. Choose the module name from the repository domain vocabulary.", FilePath: "src/d/types.ts", Line: 3, Column: 18},
	})
}
