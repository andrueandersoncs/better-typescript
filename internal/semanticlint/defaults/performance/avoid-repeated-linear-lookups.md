...
Do not report small fixed collections, lookup data that changes each iteration, or cases where indexing would change observable semantics. Report only when this file shows repeated scans of stable lookup data at variable input scale.
