...
Do not report fixed small inputs, sequential traversal, or work already governed by an enclosing shared limiter. Report only when this file can start input-dependent work without an enforced concurrency bound.
