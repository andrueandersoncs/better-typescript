...
Do not report a deliberate time-boundary test driven by a fake or controlled clock. Report only when changed test behavior depends on elapsed wall-clock time or can assert absence before the relevant operation completes.
