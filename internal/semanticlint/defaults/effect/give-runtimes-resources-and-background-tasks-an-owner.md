...
Report only when this file reacquires application-lifetime services per operation, lets an acquired resource escape cleanup, or detaches work without an owner responsible for interruption and shutdown.
