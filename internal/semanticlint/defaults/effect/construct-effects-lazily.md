...
Do not report deliberately eager values whose work is trivial and side-effect free. Report only when constructing an Effect in this file starts observable or expensive work before execution.
