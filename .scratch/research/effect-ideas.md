...
At the scan baseline, Better TypeScript had 132 detail pages and separate rule fixtures. The live final-review workspace has 134 after the concurrent `prefer-effect-object` and `related-kind-files` additions. A narrow documentation test would catch drift between public examples and actual diagnostics without importing Effect's full Vitest plugin.
...
- Better TypeScript overlap started from the complete 132-rule baseline package, catalog, and public-doc inventory. The live final state reached 134 rule packages and 134 detail pages after the concurrent `prefer-effect-object` addition and the later `related-kind-files` addition. The concurrent `unsafe-casts` behavior was included when the double-assertion candidate was refreshed. The closest code, tests, fixtures, scripts, package files, and docs were read for each decision.
...
| Source tree | `df4e5d0a90bc7bc64dce7c6dd77ac51e0b0780a4` |
| Better TypeScript fingerprint | `728ba2a16d2ee308b818541cadb6b3101ea79dee2ee761934388abaa9b86dd51` |
| Better TypeScript manifest | 868 unique regular files; scope: `internal/rules/**`, `internal/rules/catalog.go`, `docs/rules.md`, `docs/rules/**`, `skills/better-typescript/SKILL.md` |
...
| State key | `1fce5f1413dbcaefc3caeacce695efc3cb228c0c4ac74dca396e8268b4fe4b71` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `docs-ci` | `other` | `**/*.md`; `**/*config*.cjs`; `**/*config*.js`; `**/*config*.json`; `**/*config*.mjs`; `**/*config*.ts`; `**/*spec*.ts`; `**/*test*.ts`; `**/__tests__/**`; `**/test/**`; `**/tests/**`; `.github/**`; `docs/**` | `**/*.map`; `**/*.min.js`; `**/.cache/**`; `**/.turbo/**`; `**/build/**`; `**/coverage/**`; `**/dist/**`; `**/node_modules/**`; `.git/**` | explicit doctest files, cited `.github/workflows/check.yml` ranges, literal config/test/docs paths, and Better TypeScript rule docs/check script | `partial` | `145d8e1013220425b8edf34f7011c73f73e1cdcf` | `AUTO-DOCS-CI`, `GAP-PROTOTYPE-001`, `GAP-VERIFY-001` |
| `perf-size-ci` | `other` | `**/*bench*`; `**/*perf*`; `**/*size*`; `**/package.json`; `.github/**`; `package.json`; `scripts/**` | `**/*.map`; `**/*.min.js`; `**/.cache/**`; `**/.turbo/**`; `**/build/**`; `**/coverage/**`; `**/dist/**`; `**/node_modules/**`; `.git/**` | `packages/effect/typeperf/**`, `packages/effect/runtimeperf/**`, `scripts/bundle-compare.sh`, bundle reporter, cited check workflow ranges, and Better TypeScript pack/check scripts | `partial` | `145d8e1013220425b8edf34f7011c73f73e1cdcf` | `AUTO-PERF-SIZE-CI`, `GAP-VERIFY-001` |
| `release-distribution` | `other` | `**/*pack*`; `**/*publish*`; `**/*release*`; `**/package.json`; `.changeset/**`; `.github/**`; `changesets/**`; `npm/**`; `package.json`; `scripts/**` | `**/*.map`; `**/*.min.js`; `**/.cache/**`; `**/.turbo/**`; `**/build/**`; `**/coverage/**`; `**/dist/**`; `**/node_modules/**`; `.git/**` | Changeset guidance, release workflow, package provenance settings, and Better TypeScript publish scripts, npm tests, and distribution docs | `partial` | `145d8e1013220425b8edf34f7011c73f73e1cdcf` | `AUTO-RELEASE-DISTRIBUTION`, `GAP-VERIFY-001` |
| `rules` | `lint` | `**/*.cts`; `**/*.mts`; `**/*.ts`; `**/*.tsx` | `**/*.map`; `**/*.min.js`; `**/.cache/**`; `**/.turbo/**`; `**/build/**`; `**/coverage/**`; `**/dist/**`; `**/node_modules/**`; `.git/**` | Effect custom oxlint rules and focused tests; cited production TypeScript patterns; Schema guide; complete legacy Better TypeScript rule/catalog/docs inventory and closest rule code, tests, fixtures, and docs | `complete-targeted` | `145d8e1013220425b8edf34f7011c73f73e1cdcf` | `GAP-PROTOTYPE-001`, `GAP-VERIFY-001` |
