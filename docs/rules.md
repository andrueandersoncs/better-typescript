...
`no-type-specific-equivalence-strict` reports every top-level primitive-specific `Equivalence.strictEqual` binding.
...
- [`no-chained-type-assertions`](./rules/no-chained-type-assertions.md)
...
- [`no-known-value-widening`](./rules/no-known-value-widening.md)
- [`no-manual-effect-error-tag`](./rules/no-manual-effect-error-tag.md)
- [`no-manual-tag-comparison`](./rules/no-manual-tag-comparison.md)
- [`no-manual-tagged-construction`](./rules/no-manual-tagged-construction.md)
- [`no-manual-tagged-union`](./rules/no-manual-tagged-union.md)
- [`no-manual-type-dispatch`](./rules/no-manual-type-dispatch.md)
- [`no-module-mocking`](./rules/no-module-mocking.md)
...
- [`no-reflect-apply`](./rules/no-reflect-apply.md)
- [`no-reflect-get`](./rules/no-reflect-get.md)
- [`no-runtime-typeof`](./rules/no-runtime-typeof.md)
...
- [`no-service-constructor-imports`](./rules/no-service-constructor-imports.md)
- [`no-shape-in-symbol-names`](./rules/no-shape-in-symbol-names.md)
...
- [`no-unsafe-dictionary-type`](./rules/no-unsafe-dictionary-type.md)
...
- [`no-widen-then-assert`](./rules/no-widen-then-assert.md)
...
- [`prefer-effect-match`](./rules/prefer-effect-match.md)
...
- [`require-safety-comment-for-type-assertion`](./rules/require-safety-comment-for-type-assertion.md)
