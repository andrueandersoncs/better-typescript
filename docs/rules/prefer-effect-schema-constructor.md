...
A string `_tag` makes the report name that tagged variant. Empty object literals are allowed. Returns with a foreign return contract are allowed. Identifier-shorthand bags of already-bound values are allowed.
