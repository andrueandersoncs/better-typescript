...
export interface User { readonly id: number; readonly name: string }
...
export interface Tag { readonly label: string }
export const tags: ReadonlyArray<Tag> = [{ label: "a" }]

// 4. Effect-boxed construction
export interface Account { readonly balance: number }
export const maybeAccount: Option.Option<Account> = Option.some({ balance: 100 })
