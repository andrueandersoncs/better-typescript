...
const collectAstSignatures = async (project: LoadedProject): Promise<ReadonlyArray<string>> => {
...
const reportFromTestWiring = (wiring: Wiring) => reportFromConfig(configFor(wiring))
